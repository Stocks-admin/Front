...
import SymbolInput from "@/pages/wallet/components/SymbolInput";
import { createMassiveTransactionsCocos } from "@/services/transactionServices";
...
const schema = yup.object().shape({
  ...
  market: yup.string().required("El mercado es requerido"),
});

const CocosMassiveLoad = () => {
  ...
  const onSubmit = (data: FieldValues) => {
    ...
    createMassiveTransactionsCocos(body)
      .then((res) => {
...
export default CocosMassiveLoad;
